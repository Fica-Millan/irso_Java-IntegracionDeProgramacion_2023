...
public class Ejercicio_06 {
	...
	public void cargarValores() {
		...
		for (int i = 0; i < vector.length; i++) {
			System.out.print("Ingrese un num entre 28 y 555 para la posición "+(i + 1)+": ");
			int numero = scanner.nextInt();

			// Validar que el número esté en el rango especificado
			while (numero <= 28 || numero >= 555) {
				System.out.println("Error: Ingrese un num entre 28 y 555.");
				System.out.print("Ingrese un num para la posición " + (i + 1) + ": ");
