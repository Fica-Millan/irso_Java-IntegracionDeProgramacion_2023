...
public class Ejercicio_05 {
	...
	public void cargarValores() {
		...
		for (int i = 0; i < matriz.length; i++) {
			for (int j = 0; j < matriz[i].length; j++) {
				System.out.print("Ingrese nº entre -100 y 10 para la posición ["+i+"]["+j+"]:");
				int numero = scanner.nextInt();

				// Validar que el número esté en el rango especificado
				while (numero < -100 || numero > 10) {
					System.out.println("Error: Ingrese un numero entre -100 y 10.");
					System.out.print("Ingrese un numero para la posición ["+i+"]["+j+"]: ");
	...
	public static void main(String[] args) {
		// Crear una matriz 2x2 y cargar valores
		Ejercicio_05 matrizOperaciones = new Ejercicio_05(2, 2);
